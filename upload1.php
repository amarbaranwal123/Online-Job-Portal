...
<html>
<head>
<link rel="stylesheet" href="css/upstyle1.css">
</head>
<body>
...
<div id="outer">
              ...
              <div id="header">
			   ...
			   <form action="upcode12.php" method="post"  enctype="multipart/form-data">
                             ...
                             <tr><br/><td><input type="text" name="name" placeholder="please enter cname" style="height:35px; width:200px;"/></td></tr></p>
							 
							 
							 
							<p style="font-size:30px; color:black; margin-left:60px; margin-top:10px;"> <th>DESIGNATION:</th>
                             <tr><br/><td><input type="text" name="des" placeholder="please enter location" style="height:35px; width:200px;"/></td></tr></p>
                             ...
                             <tr><br/><td><input type="number" name="age" placeholder="please enter your age" style="height:35px; width:200px;"/></td></tr></p>  
							 
							 
							 
							 
							<p style="font-size:30px; color:black; margin-left:60px; margin-top:10px;">  <th>QUALIFICATION:</th>
                             <tr><br/><td><textarea name="qua" placeholder="please enter your qualification" style="height:35px; width:200px;"></textarea></td></tr><br/></p>
                             ...
                             <tr><br/><td><textarea name="key"></textarea></td></tr><br/></p> 
							  <tr>
						 ...
						 <p style="font-size:30px; color:black; margin-left:60px; margin-top:10px;"> <th>COURSE CATEGORY:</th>
                             <tr><br/><td><select name="cat">
							 <option value="ps">please choose</option>
							  <option value="engg">BCA</option>
							   <option value="bba">BBA</option>
							    <option value="engg">MCA</option>
								
								</select></td></tr></p>
							 
							 
							 <p style="font-size:30px; color:black; margin-left:60px; margin-top:10px;"> <th>EXPERIENCE:</th>
                             <tr><br/><td><input type="text" name="experience" placeholder="please enter" style="height:35px; width:200px;"/></td></tr></p>
		        
							
							
							 <p style="font-size:30px; color:black; margin-left:60px; margin-top:10px;"> <th>UPLOAD CV:</th>
                             <tr><br/><td><input type="file" name="file"/></td></tr></p>   
